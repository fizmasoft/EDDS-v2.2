...
{
    public partial class KategoriTexniki : UserControl
    {
        PgSQL DB;
        public KategoriTexniki(PgSQL _DB)
        {
            InitializeComponent();
            DB = _DB;
        }

        private void KategoriTexniki_Load(object sender, EventArgs e)
        {
            InitializeTable();
        }
        ...
        private void UpdateRows()
        {
            ...
            DataTable DT = DB.ExecuteReader("SELECT id, name FROM edds_technics_type ORDER BY id");
