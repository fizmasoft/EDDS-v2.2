...
{
    public partial class KategoriUlits : UserControl
    {
        PgSQL DB;
        public KategoriUlits(PgSQL _DB)
        {
            InitializeComponent();
            DB = _DB;
        }

        private void KategoriUlits_Load(object sender, EventArgs e)
        {
            InitializeTable();
        }
        ...
        private void UpdateRows()
        {
            ...
            DataTable DT = DB.ExecuteReader("SELECT id, name FROM edds_street_type ORDER BY id");
