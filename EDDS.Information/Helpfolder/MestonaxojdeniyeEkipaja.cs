...
{
    public partial class MestonaxojdeniyeEkipaja : UserControl
    {
        PgSQL DB;
        public MestonaxojdeniyeEkipaja(PgSQL _DB)
        {
            InitializeComponent();
            DB = _DB;
        }

        private void MestonaxojdeniyeEkipaja_Load(object sender, EventArgs e)
        {
            InitializeTable();
        }
        ...
        private void UpdateRows()
        {
            ...
            DataTable DT = DB.ExecuteReader("SELECT id, name FROM edds_crew_actions ORDER BY id");
