...
{
    public partial class DejurniyPoShtabu : UserControl
    {
        PgSQL DB;
        public DejurniyPoShtabu(PgSQL _DB)
        {
            InitializeComponent();
            DB = _DB;
        }

        private void DejurniyPoShtabu_Load(object sender, EventArgs e)
        {
            InitializeTable();
        }
        ...
        private void UpdateColumns()
        {
            ...
            dataGridView1.Columns[dataGridView1.Columns.Add("Name", "Полное имя")].AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
